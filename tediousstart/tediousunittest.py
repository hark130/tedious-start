"""Tedious Start (TEST) unit test class module.

Tedious Start (TEST) unit test class.  Implements common functionality to unit test
functions and basic class implementations.

    Typical usage example:

    1. Inherit from TediousUnitTest
    ...
    5. Define unittest Test Cases that:
        ...
        5.3. Run Test
        self.run_test()
    6. Call execute_test_cases() (see: test.tediousstart)
"""
...
# Third Party Imports
# Local Imports
from tediousstart.tediousstart import ExceptionData, TediousStart


class TediousUnitTest(TediousStart):
    """TEST unit test class.

    This class defines necessary functionality to unit test functions and basic classes.
