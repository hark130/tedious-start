"""Unit test the TediousStart.verify_stdout_missing() methods.
...
class TestTFTVerifyStdoutMissing(TediousUnitTest):
    ...
    def call_callable(self) -> Any:
        ...
        Returns:
            Return value of TediousFuncTest.verify_stdout_missing()

        Raises:
            Exceptions raised by TediousFuncTest.verify_stdout_missing() are bubbled up and handled
            by TediousUnitTest
        """
        return self._tft_obj.verify_stdout_missing(*self._args, **self._kwargs)

    def validate_return_value(self, return_value: Any) -> None:
        """Validate TediousFuncTest.verify_stdout_missing() return value.
...
class NormalTestTFTVerifyStdoutMissing(TestTFTVerifyStdoutMissing):
    """Normal Test Cases.
...
class ErrorTestTFTVerifyStdoutMissing(TestTFTVerifyStdoutMissing):
    """Error Test Cases.
...
class BoundaryTestTFTVerifyStdoutMissing(TestTFTVerifyStdoutMissing):
    """Boundary Test Cases.
...
class SpecialTestTFTVerifyStdoutMissing(TestTFTVerifyStdoutMissing):
    """Special Test Cases.
